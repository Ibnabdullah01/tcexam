...
function F_getRawTestStat($test_id, $group_id = 0, $user_id = 0, $startdate = 0, $enddate = 0, $testuser_id = 0, $data = [], $pubmode = false)
{
    ...
    if (!isset($data['qstats'])) {
        ...
        $data['qstats'] = ['recurrence' => 0, 'recurrence_perc' => 0, 'average_score' => 0, 'average_score_perc' => 0, 'average_time' => 0, 'right' => 0, 'right_perc' => 0, 'wrong' => 0, 'wrong_perc' => 0, 'unanswered' => 0, 'unanswered_perc' => 0, 'undisplayed' => 0, 'undisplayed_perc' => 0, 'unrated' => 0, 'unrated_perc' => 0, 'qnum' => 0, 'module' => []];
    }
    ...
    if ($r = F_db_query($sql, $db)) {
        while ($m = F_db_fetch_array($r)) {
            if (!isset($data['qstats']['module']["'".$m['module_id']."'"])) {
                $data['qstats']['module']["'".$m['module_id']."'"] = ['id' => $m['module_id'], 'name' => $m['module_name'], 'recurrence' => 0, 'recurrence_perc' => 0, 'average_score' => 0, 'average_score_perc' => 0, 'average_time' => 0, 'right' => 0, 'right_perc' => 0, 'wrong' => 0, 'wrong_perc' => 0, 'unanswered' => 0, 'unanswered_perc' => 0, 'undisplayed' => 0, 'undisplayed_perc' => 0, 'unrated' => 0, 'unrated_perc' => 0, 'qnum' => 0, 'subject' => []];
            }
            ...
            if (!isset($data['qstats']['module']["'".$m['module_id']."'"]['subject']["'".$m['subject_id']."'"]['question']["'".$m['question_id']."'"])) {
                $data['qstats']['module']["'".$m['module_id']."'"]['subject']["'".$m['subject_id']."'"]['question']["'".$m['question_id']."'"] = ['id' => $m['question_id'], 'description' => $m['question_description'], 'type' => $m['question_type'], 'difficulty' => $m['question_difficulty'], 'recurrence' => 0, 'recurrence_perc' => 0, 'average_score' => 0, 'average_score_perc' => 0, 'average_time' => 0, 'right' => 0, 'right_perc' => 0, 'wrong' => 0, 'wrong_perc' => 0, 'unanswered' => 0, 'unanswered_perc' => 0, 'undisplayed' => 0, 'undisplayed_perc' => 0, 'unrated' => 0, 'unrated_perc' => 0, 'qnum' => 0, 'anum' => 0, 'answer' => []];
            }
            ...
            if ($ra = F_db_query($sqla, $db)) {
                while ($ma = F_db_fetch_array($ra)) {
                    ...
                    if (!isset($data['qstats']['module']["'".$m['module_id']."'"]['subject']["'".$m['subject_id']."'"]['question']["'".$m['question_id']."'"]['answer']["'".$ma['answer_id']."'"])) {
                            $data['qstats']['module']["'".$m['module_id']."'"]['subject']["'".$m['subject_id']."'"]['question']["'".$m['question_id']."'"]['answer']["'".$ma['answer_id']."'"] = ['id' => $ma['answer_id'], 'description' => $ma['answer_description'], 'recurrence' => 0, 'recurrence_perc' => 0, 'right' => 0, 'right_perc' => 0, 'wrong' => 0, 'wrong_perc' => 0, 'unanswered' => 0, 'unanswered_perc' => 0];
                    }
